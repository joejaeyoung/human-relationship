export type OutcomeType = 'best' | 'normal' | 'bad'
    ...
    firstChoices: [
      ...
      },
      {
        ...
        result: {
          kind: 'immediate',
          type: 'bad',
          text: '팀장: "뭐?! 분위기 파악도 못하나 지금? 한 잔도 못 마신다고?! 요즘 신입들은 왜 이러는 거야!!"\n당신: "강요하시는 거 아닙니까?? 요즘 이런 거 문제 되는 거 아세요?!!" (언성이 높아진다.)',
        },
      },
    ],
